...
def main():
    ...
    # The picker window this used to open when called with no flags is
    # retired - Control Center's Scene view (EnvironmentHero) is the real
    # replacement now, with the same presets/swatches/brightness/
